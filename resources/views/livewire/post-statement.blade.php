<div class="static {{$view=='card'?'':'my-4'}}" x-data="{open:false,other:false}">
    ...
    <div class="fixed max-w-full overflow-auto z-50 border rounded p-4 bg-white inset-10 sm:inset-1/4" style="display: none;" x-init={open:false,other:false} x-show="open">
