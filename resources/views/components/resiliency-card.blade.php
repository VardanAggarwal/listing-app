<div class="">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-8 gap-4 items-center">
        ...
        <div class="sm:col-span-1 justify-self-center">
            <a href="/resiliencies/{{$model->id}}"><img src="{{$model->image_url}}" loading="lazy" class="rounded-lg h-24 w-24 object-cover" /></a>
        </div>
        @endif
    ...
    <div>
        @livewire('card-interests',['model'=>$model,'type'=>'Resiliency'], key($index.'resiliency-'.$model->id))
    </div>
</div>