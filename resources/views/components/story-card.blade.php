<div class="">
      ...
      <div class="sm:col-span-7">
        ...
        <div>
          <a href="/stories/{{$model->id}}">
            <div class="overflow-clip overflow-hidden max-h-12 max-w-full">{!!strip_tags($model->review)!!}</div>
          </a>
  ...
  <div>
      @livewire('card-interests',['model'=>$model,'type'=>'Story'], key($index.'story-'.$model->id))
  </div>
</div>